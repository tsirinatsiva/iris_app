...
hist_data = [iris_filtered['sepal_length'],iris_filtered['sepal_width'],iris_filtered['petal_length'],iris_filtered['petal_width']]
group_labels = ['sepal_length','sepal_width','petal_length','petal_width']

st.markdown('## Distribution Plot per features')
fig_2 = ff.create_distplot(hist_data, iris_filtered, group_labels, bin_size = [0.25,0.25,0.25,0.25])
